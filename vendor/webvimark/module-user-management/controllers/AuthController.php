...
class AuthController extends BaseController
{
    ...
    {
        $this->layout = '@vendor/dmstr/yii2-adminlte-asset/example-views/yiisoft/yii2-app/layouts/main-login';
        ...
        {
            // return $this->goBack();
            return $this->redirect(['/participant']);
    ...
    {
        // $this->layout = 'loginLayout'; //your layout name
        $this->layout = '@vendor/dmstr/yii2-adminlte-asset/example-views/yiisoft/yii2-app/layouts/main-login';
