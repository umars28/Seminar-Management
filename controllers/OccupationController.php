...
class OccupationController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Occupation",
                    'content'=>'<span class="text-success">Create Occupation success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'#crud-datatable-pjax',
                    'title'=> "Occupation #".$id,
                    'content'=>'<span class="text-success">Update Occupation success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Edit',['update','id'=>$id],['class'=>'btn btn-primary','role'=>'modal-remote'])
                ];    
            }else{
    ...
    /**
     * Delete an existing Occupation model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Occupation model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
